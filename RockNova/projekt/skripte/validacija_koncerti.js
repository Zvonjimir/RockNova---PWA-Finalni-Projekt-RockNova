document.addEventListener("DOMContentLoaded", function () {
  ...
  const predgrupa = document.getElementById("predgrupa");
  ...
  spremiBtn.onclick = (event) => {
    ...
    if (predgrupa.value.length == 0) {
      slanje_forme = false;
      predgrupa.style.border = "1px dashed red";
      document.getElementById("porukaPredgrupa").innerHTML =
        "Predgrupa mora biti unesena!<br>";
    } else {
      predgrupa.style.border = "1px solid green";
      document.getElementById("porukaPredgrupa").innerHTML = "";
    }
